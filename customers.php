...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">The Sparks Foundation Bank of INDIA</a>
...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <button type="button" class="btn">Transfer money</button>
                      </a></td> 
                    </tr>
                <?php
                    }
         ...
         <footer class="text-center mt-5 py-2">
            <p style="color:#E1F7F5;">&copy 2024 <b>SHIVAM PATRA</b> <br>TSF Bank of INDIA</p>
        </footer>
